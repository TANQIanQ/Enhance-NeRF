...
class RGBTUNEHead(FieldHead):
    ...
    def __init__(self, in_dim: Optional[int] = None, activation: Optional[nn.Module] = nn.Sigmoid()) -> None:
        super().__init__(in_dim=in_dim, out_dim=1, field_head_name=FieldHeadNames.RGBTUNE, activation=activation)


class LinearHead(FieldHead):
    """RGB output
    ...
    def __init__(
        ...
        super().__init__(in_dim=in_dim, out_dim=out_dim, field_head_name=FieldHeadNames.RGBTUNE, activation=activation)
