...
from nerfstudio.models.StitchMonster_model import StitchMonsterModelConfig
from nerfstudio.models.StitchMonster_depth_model import StitchMonster_depthModelConfig
from nerfstudio.models.SM import SMConfig
...
descriptions = {
    ...
    "sm": "StitchMonsterModel",
    "depth": "StitchMonster_depthModel",
    "sw":"m-w"
}

method_configs["sm"] = TrainerConfig(
    method_name="sm",
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=StitchMonsterModelConfig(eval_num_rays_per_chunk=1 << 15),
    ),
    optimizers={
        "proposal_networks": {
...
method_configs["sw"] = TrainerConfig(
    method_name="sw",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=SMConfig(eval_num_rays_per_chunk=1 << 15),
    ),
    optimizers={
        "proposal_networks": {
            "optimizer": AdamOptimizerConfig(lr=1e-2, eps=1e-15),
...
method_configs["depth"] = TrainerConfig(
    method_name="depth",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=StitchMonster_depthModelConfig(eval_num_rays_per_chunk=1 << 15),
    ),
    optimizers={
        "proposal_networks": {
            "optimizer": AdamOptimizerConfig(lr=1e-2, eps=1e-15),
